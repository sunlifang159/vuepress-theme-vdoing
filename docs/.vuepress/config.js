...
module.exports = {
  ...
  themeConfig: {
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'xuelitec:support@lplinkpi.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/sunlifang159'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'xuelitec | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
